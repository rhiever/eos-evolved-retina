...
int main(int argc, char *argv[])
{
    ...
    swarmAgent->loadAgent("startPrey.genome");
	...
	for(int i = 0; i < populationSize; ++i)
    {
        ...
        predatorAgents[i]->visionAngle = randDouble * 180.0;
    }
    ...
    fprintf(LOD, "generation,prey_fitness,predator_fitness,num_alive_end,avg_bb_size,var_bb_size,avg_shortest_dist,swarm_density_count,prey_neurons_connected_prey_retina,prey_neurons_connected_predator_retina,predator_neurons_connected_prey_retina,num_attacks,pred_vision_angle\n");
